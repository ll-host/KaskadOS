...
PORTAL_SERVICE_NAME: Final = "org.freedesktop.impl.portal.desktop.macqueen"
...
class OrgFreeDesktopAppearanceTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        if not portal_launched:
            ...
            cls.portal_process = subprocess.Popen([os.path.join(CMAKE_RUNTIME_OUTPUT_DIRECTORY, "xdg-desktop-portal-macqueen")], env=debug_environ, stdout=sys.stderr, stderr=sys.stderr)
            for _ in range(10):
