...
int main(int argc, char *argv[])
{
    ...
    KAboutData about(QStringLiteral("xdg-desktop-portal-macqueen"), QString(), QStringLiteral(XDPK_VERSION_STRING));
    about.setDesktopFileName(QStringLiteral("org.freedesktop.impl.portal.desktop.macqueen"));
    ...
    if (sessionBus.interface()->registerService(u"org.freedesktop.impl.portal.desktop.macqueen"_s, dbusQueueOption, QDBusConnectionInterface::AllowReplacement)) {
        ...
        qCDebug(XdgDesktopPortalKde) << "Failed to register org.freedesktop.impl.portal.desktop.macqueen service";
        return 1;
    }
